...
PROCESS {
    Try {
        ...
        Add-吴乐川添加单个集得源  -集得源在本机采用的名称 '吴乐川：码云' `
            -特征颜色 'Red'       -集得源之完整地址 'git@gitee.com:nanchang-wulechuan/wulechuan--typescript--controller--enhanced-web-storage.git'

        # Add-吴乐川添加单个集得源  -集得源在本机采用的名称 '吴乐川：阿里云' `
        #     -特征颜色 'Blue'      -集得源之完整地址 'git@code.aliyun.com:wulechuan/wulechuan--typescript--controller--enhanced-web-storage.git'

        Add-吴乐川添加单个集得源  -集得源在本机采用的名称 '吴乐川：GitHub' `
            -特征颜色 'Yellow'    -集得源之完整地址 'git@github.com:wulechuan/wulechuan--typescript--controller--enhanced-web-storage.git'
